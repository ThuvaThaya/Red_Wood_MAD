...
public class BookingDetailsAdapter extends BaseAdapter {
    ...
    public BookingDetailsAdapter(Context context, ArrayList<BookingDetail> bookingDetailsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView ==  null) {
            convertView = View.inflate(context, R.layout.booking_detail_card, null);
        }
